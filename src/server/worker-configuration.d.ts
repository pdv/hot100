// Generated by Wrangler by running `wrangler types src/server/worker-configuration.d.ts` (hash: 2e9352ac36ff75021d840c81788d0c88)
// Runtime types generated with workerd@1.20250409.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MCP_OBJECT: DurableObjectNamespace<import("./index").MCP>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
